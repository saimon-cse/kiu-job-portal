<div class="space-y-6">
    ...
    <div>
        ...
        <div class="mt-1">
            <input type="text" name="exam_name" id="exam_name" value="{{ old('exam_name', isset($education) ? $education->exam_name : '') }}" required
    ...
    <div>
        ...
        <div class="mt-1">
            <input type="text" name="institution_name" id="institution_name" value="{{ old('institution_name', isset($education) ? $education->institution_name : '') }}" required
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div>
            ...
            <div class="mt-1">
                <input type="number" name="passing_year" id="passing_year" value="{{ old('passing_year', isset($education) ? $education->passing_year : '') }}" required
        ...
        <div>
            ...
            <div class="mt-1">
                <input type="text" name="gpa_or_cgpa" id="gpa_or_cgpa" value="{{ old('gpa_or_cgpa', isset($education) ? $education->gpa_or_cgpa : '') }}"
